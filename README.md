# 👋 Olá, eu sou Alberth Luiz

🎯 Engenheiro de Dados | Cientista de Dados em formação  
📍 Paulista, Pernambuco - Brasil  
📫 [aluizprofi@gmail.com](mailto:aluizprofi@gmail.com) | [LinkedIn](https://linkedin.com/in/alberth-luiz-736527229) | [GitHub](https://github.com/alberth-luiz-data)

---

## 🚀 Competências Técnicas
- **Linguagens:** Python, SQL, JavaScript  
- **Engenharia de Dados:** PySpark, ETL/ELT, Data Factory, Databricks  
- **Cloud & DevOps:** Microsoft Azure, AWS, Git/GitHub  
- **Bancos de Dados:** MySQL, PostgreSQL, MongoDB, SSMS, Modelagem Dimensional  

---

## 💼 Experiência Profissional
- **Deloitte** – Engenheiro de Dados *(Mar 2025 – presente)*  
  - Desenvolvimento de pipelines ETL escaláveis com Python e SQL  
